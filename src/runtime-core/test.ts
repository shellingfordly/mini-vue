...
export function createRenderer({
  ...
  function patchChildren(n1, n2, container, parentInstance) {
    ...
    if (nextShapeFlag & ShapeFlag.TEXT_CHILDREN) {
      ...
      if (isTextChildren(prevShapeFlag)) {
        ...
        patchKeyedChaildren(c1, c2, container, parentInstance);
      }
    }
  }

  function patchKeyedChaildren(c1, c2, container, parentInstance) {}
  ...
  function mountElement(vnode, container, parentInstance) {
    ...
    if (isTextChildren(shapeFlag)) {
      ...
      mountChildren(vnode.children, el, parentInstance);
    }
